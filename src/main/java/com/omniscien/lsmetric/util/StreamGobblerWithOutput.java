...
public class StreamGobblerWithOutput extends Thread {
	 ...
	 InputStream inputStream;
	  ...
	  public StreamGobblerWithOutput(String name, InputStream inputStream)
	  {
		  super(name);
	  ...
	  public StreamGobblerWithOutput(String name, InputStream inputStream, OutputStream outputStream, String inputParam)
	  {
		super(name);
	    this.inputStream = inputStream;
